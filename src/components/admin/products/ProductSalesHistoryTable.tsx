/**
 * Product Detail's Recent Sales table — this task's "Product Detail Page"
 * §6. Clicking a row opens the existing Sales Register Edit flow via the
 * same `?sale=<id>` deep-link already used by
 * RetailerSalesHistoryTable.tsx — no new sale detail view is built here.
 */
...
interface ProductSalesHistoryTableProps {
  sales: SaleDTO[];
}
    ...
    <div className="premium-card overflow-hidden">
      ...
      {sales.length === 0 ? (
        <EmptyState
          ...
          message="Once a sale is entered for this product, it will appear here."
        />
      ) : (
