 ...
 * explicit "Never hard delete" requirement). Mirrors RetailerStatusDialog.tsx.
 */
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto bg-brown-900/40 p-4 backdrop-blur-sm">
      <div className="premium-card w-full max-w-md p-6">
        <h2 className="font-heading text-lg font-bold text-brown-900">
          {willDeactivate ? "Deactivate" : "Activate"} {productName}?
        </h2>
        <p className="mt-2 text-sm text-brown-500">
          {willDeactivate
            ? "This product will no longer be selectable when adding a new sale. It stays visible and searchable here, and remains linked to every historic sale."
            : "This product will become selectable again when adding a new sale."}
        </p>
