...
/**
 * Search box + Add Product button. The only genuinely client-side state
 * in this whole module is the debounced search text below — mirrors
 * RetailersToolbar.tsx exactly. Search itself is server-side (this task's
...
export default function ProductsToolbar({ initialSearch }: ProductsToolbarProps) {
