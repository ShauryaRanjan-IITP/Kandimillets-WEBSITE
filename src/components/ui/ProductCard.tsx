...
export default function ProductCard({ product }: ProductCardProps) {
  const whatsappUrl = `${siteConfig.contact.whatsappUrl}&text=${encodeURIComponent(
    `Hi Kandimillets, I'm interested in ${product.name}.`
  )}`;

  return (
    <div className="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-warm-200 hover:-translate-y-0.5">
      {/* Product Image */}
      ...
      <div className="p-5">
        ...
        <div className="mt-4 flex gap-3">
          ...
          <a
            ...
            className="flex-1 inline-flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2.5 px-4 rounded-xl transition-colors"
          >
