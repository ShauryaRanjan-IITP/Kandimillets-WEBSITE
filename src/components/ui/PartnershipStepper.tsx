...
const steps = [
  {
    number: 1,
    title: "Call / WhatsApp",
    description: "Reach out to us to express your interest",
  },
  {
    number: 2,
    title: "Discussion",
    ...
    <div className="w-full">
      ...
      <div className="flex flex-wrap gap-4 justify-center mt-10">
        <a
          ...
          className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg"
        >
