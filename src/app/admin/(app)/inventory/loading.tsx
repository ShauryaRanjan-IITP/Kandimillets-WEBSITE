/**
 * Next.js file-based loading UI for the /admin/inventory segment — shown
 ...
 * Mirrors src/app/admin/(app)/products/loading.tsx.
 */
...
export default function InventoryLoading() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8" aria-busy="true" aria-label="Loading inventory">
