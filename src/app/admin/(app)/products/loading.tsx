/**
 * Next.js file-based loading UI for the /admin/products segment — shown
 ...
 * Mirrors src/app/admin/(app)/retailers/loading.tsx.
 */
...
export default function ProductsLoading() {
  return (
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8" aria-busy="true" aria-label="Loading products">
